...
const ALL_IMAGES = [
  { img: "/work/mockups/facewash-mockup.png", label: "Mockup Design",     tag: "3D Visual",         glow: "rgba(14,165,233,0.7)" },
  { img: "/work/mockups/serum-mockup.png",    label: "Product Mockup",    tag: "Premium Visual",    glow: "rgba(56,189,248,0.65)" },
  { img: "/work/social-media/social-post-1.png", label: "Social Creative", tag: "Campaign",         glow: "rgba(109,40,217,0.6)" },
  { img: "/work/mockups/facewash-mockup.png", label: "Packaging Design",  tag: "Brand Identity",    glow: "rgba(14,165,233,0.7)" },
  { img: "/work/mockups/serum-mockup.png",    label: "Hero Mockup",       tag: "Launch Asset",      glow: "rgba(56,189,248,0.65)" },
  { img: "/work/social-media/social-post-1.png", label: "Social Post",     tag: "Ad Creative",       glow: "rgba(109,40,217,0.6)" },
  { img: "/work/mockups/facewash-mockup.png", label: "Studio Mockup",     tag: "Product Shot",      glow: "rgba(14,165,233,0.7)" },
  { img: "/work/mockups/serum-mockup.png",    label: "Feature Mockup",    tag: "A+ Content",        glow: "rgba(56,189,248,0.65)" },
  { img: "/work/social-media/social-post-1.png", label: "Social Banner",   tag: "Brand System",      glow: "rgba(109,40,217,0.6)" },
];
    ...
    <div className="hero-fan-root">
      ...
      <div className="hero-fan-heading-wrap">
        <div className="hero-fan-pill">
          ...
          <span className="text-slate-600 font-semibold dark:text-slate-300">Premium Digital Partner</span>
        </div>
